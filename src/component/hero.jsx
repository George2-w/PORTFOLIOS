    ...
    return (
        <div>
            <div className='hero-main-Text relative '>
                ...
                <div className='text-black absolute top-19 left-1 text-2xl font-bold w-1/2 gap-20 text-center mt-20 justify-center items-center hText'>
                        <p>Hi my name is George Ajileye I am a web developer and designer </p>
                        <p>with a passion for creating visually stunning and user-friendly websites.</p>
                </div>
                   </div>  
                ...
                <div className='justify-center items-center '>
                    <div className='text-red-500 text-3xl z-50 font-bold absolute top-80 left-100 scrolltext'>
            ...
            <section className=' w-full h-full  '>
                ...
                <div className='absolute top-40 left-330  w-1/4 h-186  z-5  text-7xl font-bold text-black opacity-27  navigationbar '>
                  ...
                  <div className=' mt-290 w-1/2 h-116 npmtext-7xl font-bold text-black  '>
                  <div className='cardBackground'></div>
                  <div className='absolute top-240 left-100 '>
                    <ClientCard/>
                  </div>
                </div>
